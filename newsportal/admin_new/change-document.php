...
$extension = substr($docfile,strlen($docfile)-4,strlen($docfile));
// allowed extensions
...
$docnewfile=md5($docfile).$extension;
...
$query=mysqli_query($con,"update tblposts set PostDocument='$docnewfile' where id='$postid'");
if($query)
{
$msg="Post Feature Document updated ";
}
else{
...
<?php
$postid=intval($_GET['pid']);
$query=mysqli_query($con,"select PostDocument,PostTitle from tblposts where id='$postid' and Is_Active=1 ");
...
<div class="col-sm-12">
 <div class="card-box">
<h4 class="m-b-30 m-t-0 header-title"><b>Current Post Document</b></h4>
...
<div class="col-sm-12">
 <div class="card-box">
<h4 class="m-b-30 m-t-0 header-title"><b>New Feature Document</b></h4>
<input type="file" class="form-control" id="postdocument" name="postdocument"  required>
</div>
</div>
</div>
